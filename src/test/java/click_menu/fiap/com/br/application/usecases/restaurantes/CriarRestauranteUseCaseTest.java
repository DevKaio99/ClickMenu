...
public class CriarRestauranteUseCaseTest {
    ...
    void deveCriarRestauranteQuandoNomeEEnderecoNaoExistentes() {
        ...
        when(restauranteRepository.validarNomeEEmailExistente("RestauranteTeste", "Rua de exemplo, 123")).thenReturn(false);
    ...
    void naoDeveCriarRestauranteQuandoNomeEEnderecoExistem() {
        ...
        when(restauranteRepository.validarNomeEEmailExistente(restauranteCreateDTO.nomeRestaurante(), restauranteCreateDTO.enderecoRestaurante())).thenReturn(true);
